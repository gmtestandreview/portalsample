...
Menu supports long press interactions in certain configurations. See the
following sections on how to handle these behaviors in your tests.
...
`@react-aria/test-utils` offers common menu interaction testing utilities.
...
`Menu` pattern tester in your test cases. The tester has methods that you can
