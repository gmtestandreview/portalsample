...
ListBox supports long press interactions on its options in certain
...
`@react-aria/test-utils` offers common listbox interaction testing utilities.
...
`ListBox` pattern tester in your test cases. The tester has methods that you can
