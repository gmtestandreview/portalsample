...
Table supports long press interactions on its rows in certain configurations.
See the following sections on how to handle these behaviors in your tests.
...
`@react-aria/test-utils` offers common table interaction testing utilities.
...
`Table` pattern tester in your test cases. The tester has methods that you can
