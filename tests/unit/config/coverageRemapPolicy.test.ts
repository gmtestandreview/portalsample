...
import termsConfig from '../../../ClientApp/src/terms-config.json' with { type: 'json' };
...
const evaluationSpikeNotCovered = [
  'ClientApp/src/components/react-aria-evaluation/primitives/ListBox.tsx',
  'ClientApp/src/components/react-aria-evaluation/primitives/Menu.tsx',
  'ClientApp/src/components/react-aria-evaluation/primitives/Table.tsx',
  'ClientApp/src/components/react-aria-evaluation/primitives/Tree.tsx',
...
const verifiedInStorybook = [
  'ClientApp/src/components/react-aria-evaluation/primitives/RangeCalendar.tsx',
  'ClientApp/src/components/react-aria-evaluation/primitives/Slider.tsx',
  'ClientApp/src/components/react-aria-evaluation/primitives/Switch.tsx',
...
const allowedExclusionCategories = [
  ...
  /\/storybook\/\*\*$/u,
  /\/components\/App\/\*\*$/u,
  /\/components\/react-aria-evaluation\/primitives\/main\.tsx$/u,
