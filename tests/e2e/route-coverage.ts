...
export const routeCoverage: RouteCoverageEntry[] = [
  ...
  },
  {
    path: '/dashboard-ta',
    status: 'app-bdd',
    feature: 'tests/e2e/features/@type-approval/type-approval.feature',
  ...
  },
  {
    ...
    feature: 'tests/e2e/features/@type-approval/type-approval.feature',
    scenario:
      'Applicant manages an existing submitted type-approval application',
  },
  {
  ...
  },
  {
    path: '*',
    status: 'app-bdd',
    feature: 'tests/e2e/features/@routing/not-found.feature',
