...
_other_ operating systems — `@esbuild/android-arm64`, `@emnapi/*`, and so on — which were
...
to record. For a package _not_ on disk it had to ask the registry, and so kept both.
