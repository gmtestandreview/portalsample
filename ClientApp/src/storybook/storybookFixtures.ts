...
export const serviceResponses: ServiceDto[] = [
  {
    ...
    description:
      'Testing and calibration services for measurement instruments and artefacts.',
    icon: 'icon-test-tube',
...
export const requestForQuoteDetailsFixture = {
  ...
  model: 'U1242C',
  description:
    'Handheld multimeter used for field verification and annual compliance checks.',
  ...
  nmiFacilityDeliveryInstructions:
    'Deliver to receiving dock between 8:30am and 3:30pm.',
