...
const toAccountDetails = (
	...
	const accountCreationCompleted = !!(
		user.organisation && user.organisation?.accountCompleted === true
	);
	const accountContactCompleted = !!(
		user.contact && user.contact?.isCompleted === true
	);
