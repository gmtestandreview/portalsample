...
const DefaultTermsAndConditionModalBody = (): ReactElement => (
  <>
    <p>
      Before you begin, please read and agree to the NMI Services portal terms
      of use.
    </p>
    <h3 data-testid='termsofuse-heading'>Terms of use</h3>
    <TermsOfUse />
    <p>
      Please accept the Terms of use to continue. Alternatively, you may close
      your web browser session if you do not wish to continue.
    </p>
  </>
);
  ...
  if (showError) {
    return (
      ...
      >
        ...
        <div>
          <p className='mb-3'>
            Error found trying to save terms and condition. Try again later!
          </p>
        </div>
      </Alert>
    );
...
const TermsAndConditionModal = () => {
  const [savingTermsAndConditionError, setSavingTermsAndConditionError] =
    useState(false);
  ...
  const anchorLink = () => <AnchorLinkToNmi />;
  ...
  return (
    ...
    >
      <Modal.Header closeButton={false}>
        <SavingTermsAndConditionError
          showError={savingTermsAndConditionError}
        />
        <Modal.Title id='modal-prompt-terms' as='h2'>
