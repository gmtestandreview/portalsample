...
const AuthenticatedNavbarItems = () => {
  ...
  return (
    ...
    >
      <Dropdown.Toggle id='user-menu' variant='dark'>
        <h2 className='visually-hidden text-white'>
          Current user settings menu
        </h2>
      ...
      <Dropdown.Menu variant='dark'>
        ...
        <Dropdown.Item
          ...
          onClick={() => {
            trackGAEvent('Manage organisation');
          }}
        >
          Manage organisation
        </Dropdown.Item>
