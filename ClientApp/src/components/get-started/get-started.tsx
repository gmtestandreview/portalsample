    ...
    <>
          ...
          <Row>
            <Col md={12} lg={9}>
              ...
              <HeaderIntroText className='mb-0 col-12 col-lg-9'>
                The NMI delivers secure, user-friendly and transparent physical
                test and calibration services through the portal.
              </HeaderIntroText>
            </Col>
          </Row>
        </Container>
      ...
      <Container>
        <Row className='mb-3'>
          <Col>
            <p className='mb-0'>
              <strong>By using the portal, you can:</strong>
            </p>
            <ul className='ms-4'>
              <li>request, receive and accept quotes</li>
              <li>
                view real-time progress of quote requests and calibrations
              </li>
              <li>
                access and download calibration reports as soon as they are
                available
              </li>
            </ul>
            <p>
              The NMI plans to expand the portal to deliver other services in
              future.
            </p>
          </Col>
        </Row>
