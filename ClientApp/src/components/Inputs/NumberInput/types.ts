...
export const NumericFormatFixed =
	NumericFormat as unknown as React.FC<INumericFormatProps>;

export const PatternFormatFixed =
	PatternFormat as unknown as React.FC<INumericFormatProps>;
