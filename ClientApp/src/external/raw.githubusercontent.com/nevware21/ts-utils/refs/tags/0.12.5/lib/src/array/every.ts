 ...
 * ```
 */
export const arrEvery: <T, E extends T>(
	theArray: ArrayLike<T>,
	callbackFn: ArrPredicateCallbackFn<T, E> | ArrPredicateCallbackFn2<T>,
	thisArg?: any,
) => theArray is T[] = /*#__PURE__*/ _unwrapFunction("every", ArrProto) as any;
 ...
 * ```
 */
export const arrFilter: <T, E extends T>(
	theArray: ArrayLike<T>,
	callbackFn: ArrPredicateCallbackFn<T, E> | ArrPredicateCallbackFn2<T>,
	thisArg?: any,
) => T[] | E[] = /*#__PURE__*/ _unwrapFunction("filter", ArrProto) as any;
