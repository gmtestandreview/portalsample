 ...
 * ```
 */
export const arrIndexOf: <T>(
	theArray: ArrayLike<T>,
	searchElement: T,
	fromIndex?: number,
) => number = /*#__PURE__*/ _unwrapFunction("indexOf", ArrProto);
 ...
 * ```
 */
export const arrLastIndexOf: <T>(
	theArray: ArrayLike<T>,
	searchElement: T,
	fromIndex?: number,
) => number = /*#__PURE__*/ _unwrapFunction("lastIndexOf", ArrProto);
