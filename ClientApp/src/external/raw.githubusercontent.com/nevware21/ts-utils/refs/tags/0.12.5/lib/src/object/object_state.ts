 ...
 * ```
 */
export const objIsFrozen: (obj: any) => boolean = /*#__PURE__*/ _pureAssign(
	/*#__PURE__*/ _pureRef<typeof Object.isFrozen>(ObjClass, "isFrozen"),
	_returnFalse,
);
 ...
 * ```
 */
export const objIsSealed: (obj: any) => boolean = /*#__PURE__*/ _pureAssign(
	/*#__PURE__*/ _pureRef<typeof Object.isSealed>(ObjClass, "isSealed"),
	_returnFalse,
);
