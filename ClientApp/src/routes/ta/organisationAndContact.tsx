					...
					options={[
						{
							label: "Manufacturer",
							descriptor:
								"I am submitting this application on behalf of my own organisation",
							value: "Yes",
						...
						},
						{
							...
							descriptor:
								"I am acting on behalf of another manufacturer as their authorised agent",
							value: "No",
