...
export interface ApplicationAndInstrumentStepDto
	extends ApplicationAndInstrumentStep {
...
export type SinglePageFormProps<T extends FormikValues> = Omit<
	FormikFormProps,
	| "isLoading"
	| "promptPath"
	| "onSubmit"
...
> & {
	...
	) => SinglePageFormValues<T> | Promise<SinglePageFormValues<T>>;
