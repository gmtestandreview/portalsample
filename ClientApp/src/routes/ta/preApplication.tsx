				...
				<Container>
					<Row className="mb-4">
						<Col>
							...
							<p className="mb-2">
								Before you begin, gather documents that describe your
								instrument&apos;s design, operation and performance. These may
								include:
							</p>
							<ul>
							...
							<p>
								You&apos;ll be able to upload these documents in later steps.
							</p>
							...
							<ul>
								<li>
									...
									>
										Approval and certification procedures for measuring
										instruments (NMI P 106)
									</InTextLink>
									{/* <br />
                                    PDF 1.1MB */}
								</li>
						...
						<Col>
							...
							>
								...
								<div className="w-100">
									...
									<p>
										If this is your first time submitting a pattern approval
										application, complete the credit check form (PDF) and attach
										it along with any supporting documentation.
									</p>
