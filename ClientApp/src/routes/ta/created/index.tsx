					...
					<Row className="mb-5">
						<Col sm={12} md={10} lg={8} className="mx-auto">
							...
							>
								...
								<div>
									<h2 className="h4 mb-1">Application submitted</h2>
									<p>
										{"Your application reference number is: "}
										<strong>{`${id}`}</strong>
									</p>
									<p>
										This is a temporary number used to track your application
										while it&apos;s being reviewed.
										<br />
										Once the application has been processed, your application
										will be given a permanent reference number.
									</p>
							...
							<p>We&apos;ve received your application for pattern approval.</p>
							<p>
								A confirmation email has been sent to you, including a copy of
