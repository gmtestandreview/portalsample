					...
					<Row className="mb-5">
						<Col sm={12} md={10} lg={8} className="mx-auto">
							<h1 id="page-title" tabIndex={-1}>
								...
								{account?.details?.givenName !== undefined &&
									`${account?.details?.givenName}`}
							</h1>

							<HeaderIntroText>
								Thank you for creating your National Measurement Institute (NMI)
								Services portal account, you can now create and manage requests
								on the portal. Continue by clicking &quot;Go to dashboard&quot;
								below.
							</HeaderIntroText>
