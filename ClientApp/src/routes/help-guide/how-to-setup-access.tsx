          ...
          <Col md={8} lg={9}>
            ...
            <Row className='mb-4'>
              <Col>
                <div
                  ...
                  id='use-your-digital-id'
                  tabIndex={-1}
                >
                  <div className='body-copy reset-last mb-8' lang='en'>
                    <h3 className='mb-2'>
                      1. Use myID to create your Digital ID
                    </h3>
                    <p>
                      No need for usernames and passwords&mdash;you will use
                      myID, the Australian Government&apos;s Digital ID app, to
                      log into the NMI Services portal.
                    </p>
                    <p>
                      {
            ...
            <Row className='mb-4'>
              <Col>
                <div
                  className='anchor-section'
                  id='portal-access-for-yourself-as-principal-authority'
                  tabIndex={-1}
                >
                  <div className='body-copy reset-last mb-8' lang='en'>
                    ...
                    <h4 className='h5'>
                      <i>You are not the principal authority</i>
                    </h4>
                    <p className='mb-0'>Follow these steps:</p>
                    <ol className='mb-4'>
                      <li className='mb-2'>
                    ...
                    <p>
                      ...
                      company secretary or senior official who holds a corporate
                      or finance role.
                    </p>
                  </div>
                </div>
            ...
            <Row className='mb-4'>
              <Col>
                <div
                  className='anchor-section '
                  id='authorising-portal-access-for-your-staff'
                  tabIndex={-1}
                >
                  <div className='body-copy reset-last mb-8' lang='en'>
                    ...
                    <h4 className='h5'>
                      <i>
                        You are an individual wanting to access the NMI Services
                        portal
                      </i>
                    </h4>
                    <p className='mb-0'>Follow these steps:</p>
                    <ol className='mb-4'>
                      <li>
                        ...
                        <ul>
                          <li>
                            full name&mdash;the same one you used to set up myID
                          </li>
                          <li>
                            preferred email address to receive an authorisation
                            code&mdash;this can be a work or personal email
                      ...
                      <li>
                        ...
                        authorisation&mdash;you must complete this step within 7
                        days
                      </li>
                      <li>
                        <strong>Log in</strong>
                        {' to the '}
                        <Link to='/'>NMI Services portal</Link>
                      </li>
                    </ol>
                    <p>
                      <strong>{'Tip: '}</strong>
                      ...
                      If so, they will follow the same steps as the principal
                      authority.
                    </p>
                  </div>
                </div>
