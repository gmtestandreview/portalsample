    ...
    <div aria-live='off'>
        ...
        <Container>
          ...
          <Row className='gs-wrapper'>
            <Col md={12} lg={9}>
              ...
              <HeaderIntroText>
                These resources are designed to save you time with solutions to
                common issues, helping you troubleshoot and resolve issues on
                your own.
              </HeaderIntroText>
            </Col>
          </Row>
      ...
      <Container>
        <h2 className='visually-hidden'>
          Please choose from the following help guides:
        </h2>
        <Row className='mb-2'>
          <Col>
