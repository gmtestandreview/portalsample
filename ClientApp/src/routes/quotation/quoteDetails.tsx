		...
		<>
							...
							<Col>
								...
								>
									...
									<div>
										<strong>Important information</strong>
										<p>
											The following information is based on the information you
											have provided to us. Please view the detailed quote and
											contact your NMI test officer if any of the details are
											not correct before proceeding.
										</p>
									</div>
								</Alert>
							</Col>
					...
					<div className="-mb-4">
						{showStatusPill && (
							<>
								...
								<p className="mb-0 text-break">
									{!!quotationData?.outcomeDate &&
										`${formatDateToString(new Date(quotationData?.outcomeDate))}`}
								</p>
							</>
						)}
					</div>
			...
			<Row className="mb-3">
				<Col xs={6}>
					...
					<div className="-mb-4">
						...
						<p className="mb-0 text-break">
							{!!quotationData?.quotationOfferDate &&
								`${formatDateToString(new Date(quotationData?.quotationOfferDate))}`}
						</p>
					</div>
				</Col>
				<Col xs={6} className="text-end">
					<div className="-mb-4">
						...
						<p className="mb-0 text-break">
							{!!quotationData?.quotationValidUntil &&
								`${formatDateToString(new Date(quotationData?.quotationValidUntil))}`}
						</p>
					</div>
				</Col>
			</Row>
			<Row className="mb-3">
				<Col lg={6}>
					<div className="-mb-4">
						...
						<p className="mb-0 text-break">
							{!!quotationData?.dateInstrumentRequiredNMI &&
								`${formatDateToString(new Date(quotationData?.dateInstrumentRequiredNMI))}`}
						</p>
					</div>
				</Col>
				<Col lg={6} className="mt-3 mt-lg-0 text-lg-end">
					<div className="-mb-4">
						...
						<p className="mb-0 text-break">
							{!!quotationData?.targetDateMesurementReport &&
								`${formatDateToString(new Date(quotationData?.targetDateMesurementReport))}`}
						</p>
					</div>
				</Col>
			</Row>
			<Row className="mb-3">
				<Col md={12}>
					...
					<p>
						These are the details you provided us when requesting the
						calibration
					</p>
					<Row className="mb-3">
						<Col xs={4} md={2}>
			...
			<Row className="mb-3">
				<Col md={12}>
					...
					<p>
						The specific details of the instrument/artefact to be calibrated may
						have been updated by NMI in preparing this quotation. Please ensure
						these details are accurate, if any discrepancies are found, the NMI
						test officer listed below can be contacted for assistance.
					</p>
					<Row>
						<Col xs={12} md={5} lg={4} xl={3}>
							<div className="mb-0">Instrument/artefact to be calibrated:</div>
						</Col>
						<Col xs={12} md={7} lg={8} xl={9}>
							<p className="mb-0 text-break">
								{quotationData !== undefined &&
									`${getMakeModelDetails(quotationData)}`}
							</p>
						</Col>
					</Row>
					<Row>
					...
					<Row>
						...
						<Col xs={12} md={7} lg={8} xl={9}>
							<p className="mb-0 text-break">
								{!!quotationData?.measurementReportCertificateRequired &&
									`${quotationData?.measurementReportCertificateRequired}`}
							</p>
						</Col>
					</Row>
					<Row>
						...
						<Col xs={12} md={7} lg={8} xl={9}>
							<p className="mb-0 text-break">
								{!!quotationData?.specialConditions &&
									`${quotationData?.specialConditions}`}
							</p>
						</Col>
					</Row>
				...
				quotationData.quoteRequestStatus !== QuoteStatus.QuoteExpired && (
                    ...
                    */}
							<div className="-mb-4">
								...
								<p className="mb-0 text-break">
									{"AUD "}
									{!!quotationData?.feePayableAmount &&
										`${formatCurrencyAmount(quotationData?.feePayableAmount)}`}
									{" (inc. GST)"}
								</p>
							</div>
						</Col>
