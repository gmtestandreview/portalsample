      ...
      <Col md={12}>
        <div className='p-4 bg-light'>
          <h3 className='h5 mb-0'>
            Contact your NMI test officer if any of the details are not correct
            before proceeding.
          </h3>
          ...
          <Row>
            ...
            <Col xs={8} md={10}>
              <p className='mb-0 text-break'>
                {quotationData?.nmiTestOfficerName}
              </p>
            </Col>
            <Col xs={4} md={2}>
            ...
            <Col xs={8} md={10}>
              <p className='mb-0 text-break'>
                {quotationData?.nmiTestOfficerEmail && (
                  <a
                    href={`mailto:${quotationData?.nmiTestOfficerEmail}?subject=${mailtoSubject}`}
                  >
                    {quotationData?.nmiTestOfficerEmail}
                  </a>
                )}
