...
export const instrumentAndRequestSubmitValidation = yup.object<
  Validation<InstrumentAndRequestStep>
>({
  hasSerialNumber: yup
    ...
    .oneOf(
      Object.values(YesNo),
      'Does this instrument/artefact have a serial number available? is required'
    ),
  ...
  manufacturer: yup
    ...
    .minEntered(2)
    .maxLength(100),
  model: yup.string().label('Model').required().minEntered(2).maxLength(100),
  description: yup
    .string()
    .label('Description')
    .optional()
  ...
  measurementCategory: yup.string().label('Measurement category').required(),
  instrumentOrArtefactType: yup
    .string()
    .label('Instrument or artefact type')
    .required(),
  previousQuoteOrReportNumber: yup
    .string()
    .label('Previous NMI Quote or Report number')
    .minEntered(2)
    .maxLength(100),
  testingAndCalibrationRequirements: yup
    .string()
  ...
  measurementReportAndCertificateRequired: yup
    .string()
    .label('Measurement report and certificate required')
    .required(),
  preferredInstrumentOrArtefactAvailabilityDate: nullableDate(
    'Preferred date must be a valid date format (dd/mm/yyyy)'
  ).test(
    'is-future-date',
...
export const instrumentAndRequestSaveValidation = yup.object<
  Validation<InstrumentAndRequestStep>
>({
  hasSerialNumber: yup
    .mixed<keyof typeof YesNo>()
  ...
  manufacturer: yup
    ...
    .minEntered(2)
    .maxLength(100),
  model: yup.string().label('Model').nullable().minEntered(2).maxLength(100),
  description: yup
    .string()
    .label('Description')
    .optional()
  ...
  numberOfItems: yup
    ...
    .min(1, 'Number of items cannot be less than 1')
    .max(100, 'Number of items cannot be greater than 100'),
  measurementCategory: yup.string().label('Measurement category').nullable(),
  instrumentOrArtefactType: yup
    .string()
    .label('Instrument or artefact type')
    .nullable(),
