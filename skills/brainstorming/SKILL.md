...
6. **Write design doc** — save to `.claude/docs/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `.claude/docs/specs/YYYY-MM-DD-<topic>-design.md`
