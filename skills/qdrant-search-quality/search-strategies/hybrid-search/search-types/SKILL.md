...
[Qdrant Skills](https://skills.qdrant.tech/llms.txt) › [qdrant-search-quality](https://skills.qdrant.tech/qdrant-search-quality/SKILL.md) › [qdrant-search-strategies](https://skills.qdrant.tech/qdrant-search-quality/search-strategies/SKILL.md) › [qdrant-hybrid-search](https://skills.qdrant.tech/qdrant-search-quality/search-strategies/hybrid-search/SKILL.md) › qdrant-hybrid-search-prefetches
...
If first, help user to design logic of constructing query or/and filters on application side and then check [Combining Searches](https://skills.qdrant.tech/qdrant-search-quality/search-strategies/hybrid-search/combining-searches/SKILL.md). Don't forget to create [indices on filterable payload fields](https://skills.qdrant.tech/md/documentation/manage-data/indexing/?s=payload-index), immediately after collection creation, prior to building HNSW, so filterable HNSW could be constructed.
