...
RED baseline (agent behaviour on these tasks without the skill) is
`Needs Human Review` — it was not run in the authoring environment. Run it
before treating this skill as validated for discipline behaviour.
