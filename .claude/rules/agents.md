...
A Team uses three tiers regardless of platform. The `model:` values in agent
frontmatter are Claude Code defaults — on other platforms, select the equivalent
tier in your platform's model settings.
