...
Assess a proposed design, RFC, or PR-level structural decision before it is
built.
...
**Not for:** producing a design from scratch (`architecture-design`) or mapping
a whole unfamiliar system (`architecture-audit`).
