...
`useObjectRef` is a utility function that will give an object ref back
regardless of if a callback ref or object ref was passed in. This is useful for
passing refs to React Aria hooks.
