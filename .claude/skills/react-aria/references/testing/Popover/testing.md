...
`@react-aria/test-utils` offers common dialog interaction testing utilities.
...
`Dialog` pattern tester in your test cases. Pass `overlayType: 'popover'` to
indicate the dialog is rendered inside a `Popover`. The tester has methods that
you can call within your test to query for the dialog or simulate common
interactions.
