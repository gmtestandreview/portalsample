...
**Version 0.1.0** Vercel Engineering January 2026

> **Note:** This document is mainly for agents and LLMs to follow when
> maintaining, generating, or refactoring React and Next.js codebases at Vercel.
...
within seconds. In serverless, consider Redis for cross-process caching.
...
This approach avoids sorting when lengths differ, avoiding both computational
overhead and memory consumption for joined strings.
...
Note: RegExp with global flag (`g`) has stateful `lastIndex`. Cache and reset as
needed.

### 7.10 Use Loop for Min/Max Instead of Sort

Finding the smallest or largest element only requires a single pass. Sorting is
wasteful.
