...
description:
  ...
  for eliminating waterfalls, optimizing bundles, and improving rendering. Use
...
with 40+ rules organized by impact level. Designed to help developers eliminate
performance bottlenecks and follow best practices.
...
- **react-performance-guidelines.md**: Complete guide with all 40+ rules, code
...
2. **Focus on critical paths**: Start with eliminating waterfalls and reducing
   bundle size
