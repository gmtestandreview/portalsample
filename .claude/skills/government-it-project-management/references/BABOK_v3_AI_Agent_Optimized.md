...
> **AI-agent reference edition.** This file is a formatting and retrieval optimization of the supplied BABOK Version 3 Markdown extraction. It preserves the supplied BABOK terminology and substantive text while removing repeated page furniture and repairing Markdown hierarchy. No external factual updates have been introduced.

## Agent usage guidance

- Use this document as **reference material**, not as a mandatory sequential process.
- Preserve BABOK terms exactly when identifying knowledge areas, tasks, techniques, competencies, stakeholders, requirements, designs, and perspectives.
- Business analysis tasks may be performed sequentially, iteratively, or simultaneously when the necessary inputs are available.
- Tailor practices to the context of the initiative; the BABOK Guide does not mandate that every described practice be followed in every circumstance.
- Treat figure and table text cautiously where the supplied Markdown extraction flattened visual layouts.
- Do not silently repair an incomplete sentence or missing source fragment from memory; treat it as an extraction gap unless the supplied text elsewhere resolves it.
...
12. Appendices — Glossary, Techniques-to-Task Mapping, Contributors, and Version 2.0 change summary

## Chapter 1: Introduction

A Guide to the Business Analysis Body of Knowledge Guide) is the
globally recognized standard for the practice of business analysis. The BABOK Guide describes business analysis knowledge areas, tasks, underlying
...
engage one or more perspectives. The perspectives included in the BABOK Guide are:
...
which business analysis is practiced. The perspectives discussed in the BABOK Guide represent some of the more common views of business analysis at the time
of writing.
...
StakeholderA group or individual with a relationship to the change, the
...
and solutions.
ValueThe worth, importance, or usefulness of something to a
...
ContextThe circumstances that influence, are influenced by, and
...
Core ConceptDuring Business Analysis Planning and
...
Core ConceptDuring Elicitation and Collaboration,
business analysts...
...
Core ConceptDuring Requirements Life Cycle
...
Core ConceptDuring Strategy Analysis, business
analysts...
Change: the act of transformation
in response to a need.
...
Core ConceptDuring Requirements Analysis and Design
...
Core ConceptDuring Solution Evaluation, business
analysts...
Change: the act of transformation
in response to a need.
...
common and widespread techniques practiced within the business analysis
community. Business analysts apply their
experience and judgment in determining
which techniques are appropriate to a given situation and how to apply each
technique. This may include techniques that are not described in the BABOK Guide. As the practice of business analysis evolves, techniques will be added,
changed, or removed from future iterations of the BABOK
...
Share IdeasRecord Ideas
Build on each
others ideas
Elicit as many
ideas as possible
Create ListRate Ideas
...
Step 1.an opening step, in which the participants get involved, learn the
rules of the game, and start generating ideas,
Step 2.the exploration step, in which participants engage with one
another and look for connections between their ideas, test those
ideas, and experiment with new ideas, and
Step 3.a closing step, in which the ideas are assessed and participants
...
related or similar
features or themes.
FishbowlParticipants are divided into two groups.
...
Alternate 1Alternate 2Alternate 3
Criterion 1Meets criterionn/an/a
Criterion 2Meets criterionMeets criterionMeets criterion
Criterion 3n/aMeets criterionMeets criterion
Criterion 4Meets criterionn/an/a
...
Criterion 11Rank = 1*33Rank = 1*55Rank = 1*22
Criterion 21Rank = 1*55Rank = 1*44Rank = 1*38
Criterion 33Rank = 3*515Rank = 3*13Rank = 3*515
Criterion 45Rank = 5*15Rank = 5*525Rank = 5*315
...
Process 1.3Process 1.2
Activity 1.2.1Activity 1.1.1
Activity 1.1.2Activity 1.2.2
...
Swimlane for Role 1Swimlane for Role 2
...
). Originally designed to elaborate on a
...
Partition for Role 1Partition for Role 2
The flow of work splits.
Tasks are executed in
parallel.
...
SOStrategiesST Strategies
WOStrategiesWTStrategies
How can the group's
...
These perspectives do not presume to represent all the possible perspectives from
which business analysis is practiced. The perspectives discussed in the BABOK Guide represent some of the most common views of business analysis at the time
of writing.
...
Guide from the lens in which one is currently working.
For more
information
regarding this
structure, see
...
ApproachBrief description
Crystal ClearPart of a family of Crystal methodologies which are defined
...
on feature sets.
KanbanDoes not require fixed iterations. Work moves through the
...
ScrumA lightweight process management framework based on
...
Kano AnalysisA technique for understanding which product features will
...
PersonasFictional characters or archetypes that exemplify the way
...
customer and value.
Real OptionsAn approach to help people know when to make decisions
rather than how.
...
RetrospectivesA similar term for the Lesson Learned technique.
...
Story MappingProvides a visual and physical view of the sequence of
activities to be supported by a solution.
StoryboardingDetail visually and textually the sequence of activities that
...
mapped to business analysis tasks and practices as defined by the BABOK Guide. It also describes how each knowledge area is applied or modified with the
agile discipline.
Each knowledge area lists techniques relevant to an agile perspective. BABOK Guide techniques are found in the Techniques chapter of the BABOK

Agile Extension techniques are discussed in detail in the Agile Extension to the

Guide. This is not intended to be an exhaustive list of techniques but
...
Guide. This section describes how each knowledge area is applied or
...
deviate, to any great extent, from the BABOK Guide techniques. BABOK
...
design.
Important    In IT contexts, the term 'design' has traditionally been reserved for solution or
...
Unified Process (UP)An adaptive development approach. The inception and
...
Guide. It also describes how each knowledge area is applied or modified
...
eTOM and FRAMEWORXCommunications sector
...
Capability MapA hierarchical catalogue of business capabilities, or what
...
organization.
Information MapA catalogue of the important business concepts
...
RoadmapModels the actions, dependencies, and responsibilities
...
Value MappingValue mapping provides a holistic representation of the
...
FrameworkBrief description
ACCORDA methodological framework that maps current
...
TechniqueBrief Description
Cost AnalysisA list of the cost per activity totaled to show the detailed
...
Cycle-time AnalysisAn analysis of the time each activity takes within the
...
process.
Kaizen EventA focused, rapid effort to improve value delivery in one
specific activity or sub-process.
Process SimulationA model of the process and a set of randomized variables
