# Lean Portfolio Management® — Knowledge Check Questions
...
- B. Lean governance
- C. Agile portfolio operations
- D. Participatory budgeting
- E. Strategy and investment funding
- F. Agile program management office

**Correct answer:** B, C, E

### Question 2

**Which objective is achieved by organizing a portfolio around value?**

- A. Faster learning and shorter time to market
- B. True cost accounting metrics
- C. Increased task completion
- D. Communication across the organization

**Correct answer:** A

### Open-ended discussion question

How does Lean portfolio management mitigate and manage risk?
...
**Which two key functions do strategic themes perform? (Choose two.)**

- A. Generating lean business cases for portfolio epics
- B. Reflecting dependencies in the value stream network
- C. Connecting the portfolio to the enterprise strategy
- D. Determining key metrics to measure progress
- E. Setting context for portfolio vision and lean budgeting

**Correct answer:** C, E

### Question 2

**What is one way of expressing future intent in a Lean portfolio?**

- A. Strategic themes
- B. Investment areas
- C. Three-year delivery plans
- D. Feature roadmaps
...
What is a benefit of using strategic themes?
...
Which role is typically the epic owner for an enabler epic?
...
- C. Use weighted shortest job first to sequence opportunities
- D. Engage business owners and stakeholders in participatory budgeting

**Correct answer:** A

### Question 2

**How does Lean budgeting differ from traditional budgeting?**

- A. It leverages rolling-wave planning to allocate funds
- B. Project governance is leaner and more adaptable
- C. Annual planning is performed more efficiently
- D. More deterministic planning drives better outcomes
...
- C. Agile program management office
- D. Epic owners
...
- C. By sequencing epics for maximum benefit
- D. By centralizing strategic decisions at this level
...
- C. Determine epic allocation to Agile release trains
- D. Promote better coding practices
- E. Establish objective metrics
- F. Provide coaching and training to Agile release trains
...
- D. Identifying communities of practice
- E. Defining organizational structure
- F. Assigning people to key SAFe roles

**Correct answer:** A, B, C

### Open-ended discussion question

What is one advantage of having an Agile program management office?
...
**What is a key characteristic of a Lean quality management system?**

- A. Building the solution and compliance incrementally
- B. Investing in devops and automation testing
- C. Reducing the holding costs associated with compliance
- D. Deferring compliance to the end of solution development
