...
- relevance to the decision or action;
- Australian English and applicable style guidance;
- factual correctness against approved data;
- completeness for the artefact type;
...
- whole-of-life cost and resource implications;
- benefits, disbenefits, owners and measurement;
- delivery/lifecycle feasibility;
- architecture/reuse, data, security/privacy and operational impacts;
- sourcing/procurement dependencies;
...
- security/privacy assurance and residual-risk decisions;
- data migration/reconciliation and recovery evidence where applicable;
- release/change readiness and rollback/contingency;
- continuity/disaster-recovery dependencies where applicable;
- supplier/contract readiness;
- communications, training and support readiness;
- outstanding risks/issues and decision authority;
- benefits/service measurement after transition.

A readiness checklist is evidence input, not approval.
