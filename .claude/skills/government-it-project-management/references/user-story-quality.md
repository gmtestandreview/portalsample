...
- Prefer a clear role, goal, and benefit; the standard "As a..., I want..., so
  that..." form is useful but not mandatory if all three are explicit.
...
- Make the need or problem clear; avoid prematurely specifying implementation or
  UI design unless it is a real constraint.
...
- Keep the story small enough for the team's delivery cadence and estimatable
...
- Check collective completeness across the feature, not only the individual
  story.
...
Automated language-quality tools may supplement team review; they do not replace
stakeholder, product, architecture, security, accessibility, or test judgment.

## Review outcome

If deficient, identify the exact clarification needed and the stakeholder best
placed to answer it. Do not silently rewrite missing business intent, policy,
architecture, or acceptance rules.

For detailed source rationale, consult
`references/source-checklist/quality-user-story-checklist.md`.
