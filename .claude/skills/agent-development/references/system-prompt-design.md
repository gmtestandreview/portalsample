...
```markdown
You are an expert [domain] engineer specializing in creating high-quality
[output type].
...
```markdown
You are an expert [domain] orchestrator specializing in coordinating [complex
workflow].
...
Use the patterns above as templates, customize for your domain, and iterate
