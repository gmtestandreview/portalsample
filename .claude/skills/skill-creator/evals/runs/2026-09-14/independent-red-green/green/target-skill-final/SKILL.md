...
- `references/schema.md` — output JSON schema; read when producing structured
  output.
- `references/examples.md` — annotated outage examples; read when the outage
  type needs illustration.
