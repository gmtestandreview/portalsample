...
**Definition:** Re-testing existing functionality to ensure new changes haven't
broken anything.
...
**Date:** 2024-01-15 **Build:** v2.5.0-rc1 **Tester:** QA Team **Environment:**
Staging
...
**Remember:** Regression testing is insurance against breaking existing
functionality.
