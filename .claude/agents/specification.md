...
tools:
  ...
  search, search/searchResults, runCommands/terminalLastCommand,
  runCommands/terminalSelection, testFailure, usages, vscodeAPI,
  microsoft.docs.mcp, github
---
...
highlevel purpose, which is one of [schema, tool, data, infrastructure, process,
