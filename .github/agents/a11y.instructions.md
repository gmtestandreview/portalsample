...
description: "Comprehensive accessibility standards and anti-patterns for web development, covering WCAG 2.2 AA criteria with severity classifications, detection methods, and corrective code examples."
