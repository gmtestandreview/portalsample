...
> **⛔ Self-contained HTML — ALL CSS inline. No CDN links. Follow this exact
> 8-section structure.**

---

The HTML report has exactly 8 sections in this order. Each section MUST be
present.
...
**MUST include Trust Boundaries as one of the 5 metrics. 5th box is Code Changes
(NOT Time Between).**
...
**MUST have 13 columns: Component + S + T + R + I + D + E + A + Total +
divider + T1 + T2 + T3**
