...
Before using this workflow in a repository, confirm:

- `PROJECT_BRIEF.md` exists, or create it before relying on it
- `docs/sprint-N/` artifacts are part of the repo’s working model
- git and GitHub operations are actually available in the current workspace

If those capabilities are missing, downgrade actions like PR merges and GitHub
issue filing to documentation outputs, handoff notes, or issue drafts.
