...
Use this workflow as a heavy orchestration pattern for large or risky tasks. For
small local tasks, treat it as reference material unless the runtime actually
supports `runSubagent` and `manage_todo_list` with the exact semantics assumed here.
