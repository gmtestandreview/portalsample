...
description:
  'Analyze chatmode or prompt files and recommend optimal AI models based on
  task complexity, required capabilities, and cost-efficiency'
---
...
Analyze `.agent.md` or `.prompt.md` files to understand their purpose,
...
- `${input:filePath:Path to .agent.md or .prompt.md file}` - Absolute or
...
**File Analyzed**: `[file path]` **File Type**: [chatmode | prompt] **Analysis
Date**: [YYYY-MM-DD] **Subscription Tier**: [Free | Pro | Pro+]

---

## File Summary

**Description**: [from frontmatter] **Mode**: [ask | edit | agent] **Tools**:
[tool list] **Current Model**: [specified model or "Not specified"]
...
**Rationale**: [Detailed explanation connecting task characteristics to model
capabilities]
...
[If user specified Speed/Cost/Quality/Balanced, explain how recommendation
aligns]
...
**TL;DR**: Use **[Primary Model]** for this task due to [one-sentence
rationale]. Cost: [X]x multiplier.
...
4. Note any patterns (e.g., "All debug-related modes benefit from Claude Sonnet
   4.5")
...
**File**: `architect.agent.md` **Content**: "Review system design for
...
**File**: `django.agent.md` **Content**: "Django 5.x expert with ORM
...
**File**: `plan.agent.md` **Content**: "Research and planning mode with
