...
- [ ] `categories`: The categories for the post. These categories must be from
      the list in /categories.txt.
...
- [ ] Validation tools have been run to check for compliance with the rules and
      guidelines.
